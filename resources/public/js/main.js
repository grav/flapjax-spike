...
goog.provide("flapjax_spike.main");
goog.require("cljs.core");
goog.require("goog.dom");
goog.require("goog.dom.classes");
goog.require("flapjax");
flapjax_spike.main.update_menu = function update_menu(E, elm) {
  return flapjax.mapE.call(null, function(event) {
    goog.dom.classes.remove(elm, "active");
    if(cljs.core._EQ_.call(null, elm, event.toElement)) {
      return goog.dom.classes.add(elm, "active")
    }else {
      return null
    }
  }, E)
};
flapjax_spike.main.init = function init() {
  var frontpage_clicksE = flapjax.clicksE.call(null, "frontpage-link");
  var counting_clicksE = flapjax.clicksE.call(null, "counting-link");
  var activateE = flapjax.mergeE.call(null, frontpage_clicksE, counting_clicksE);
  flapjax_spike.main.update_menu.call(null, activateE, goog.dom.getElement("frontpage-link"));
  return flapjax_spike.main.update_menu.call(null, activateE, goog.dom.getElement("counting-link"))
};
goog.exportSymbol("flapjax_spike.main.init", flapjax_spike.main.init);
